...
function encriptarTexto () {
    ...
    var texto = document.querySelector('.area-box1').value;
    ...
    if (validarCaracteres(texto) == true) {
        ...
        textoEncriptado = "Caracter inválido, sólo lestras minúsculas y sin acento";
    }

    document.querySelector('.area-box2').value = textoEncriptado;
}
...
function desencriptarTexto () {
    ...
    document.querySelector('.area-box2').value = textoDesencriptado;
}
...
function copiarTexto () {
    var texto = document.querySelector('.area-box2').value;
